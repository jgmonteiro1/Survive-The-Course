...
public class Pergunta4 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Pergunta4 frame = new Pergunta4(0,0,0,0);
	 ...
	 * Create the frame.
	 */
	public Pergunta4(int vidaSocial, int skill, int dinheiro, int sanidade) {
		...
		Layout.setIcon(new ImageIcon(Pergunta4.class.getResource("/imagens/layout4.png")));
		...
		Resposta1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				sanidade2.setValue(sanidade2.getValue()+25);
				dinheiro2.setValue(dinheiro2.getValue()+50);
				new Pergunta5(VidaSocial.getValue(), skillProgramador.getValue(), dinheiro2.getValue(), sanidade2.getValue()).setVisible(true);;
				Pergunta4.this.dispose();
			}
		});
		Resposta1.setIcon(new ImageIcon(Pergunta4.class.getResource("/imagens/p4r1.png")));
		...
		Resposta2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(null, "Só tem uma opção aqui e nós dois sabemos qual é", "Quebra ele !", JOptionPane.ERROR_MESSAGE);
			}
		});
		Resposta2.setIcon(new ImageIcon(Pergunta4.class.getResource("/imagens/p4r2.png")));
