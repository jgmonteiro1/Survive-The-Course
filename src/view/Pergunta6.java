...
public class Pergunta6 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Pergunta6 frame = new Pergunta6(0,0,0,0);
	 ...
	 * Create the frame.
	 */
	public Pergunta6(int vidaSocial, int skill, int dinheiro, int sanidade) {
		...
		Layout.setIcon(new ImageIcon(Pergunta6.class.getResource("/imagens/layout6.png")));
		...
		Resposta1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				skillProgramador.setValue(skillProgramador.getValue()+30);
				...
				Pergunta6.this.dispose();
			}
		});
		Resposta1.setIcon(new ImageIcon(Pergunta6.class.getResource("/imagens/p6r1.png")));
		...
		Resposta2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				new Jacquin(VidaSocial.getValue(), skillProgramador.getValue(), dinheiro2.getValue(), sanidade2.getValue()).setVisible(true);
				Pergunta6.this.dispose();
			}
		});
		Resposta2.setIcon(new ImageIcon(Pergunta6.class.getResource("/imagens/p6r2.png")));
