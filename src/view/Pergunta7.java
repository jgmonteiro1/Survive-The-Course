...
public class Pergunta7 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Pergunta7 frame = new Pergunta7(0,0,0,0);
	 ...
	 * Create the frame.
	 */
	public Pergunta7(int vidaSocial, int skill, int dinheiro, int sanidade) {
		...
		Layout.setIcon(new ImageIcon(Pergunta7.class.getResource("/imagens/layout7.png")));
		...
		Resposta1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				new Gostou(VidaSocial.getValue(), skillProgramador.getValue(), dinheiro2.getValue(), sanidade2.getValue()).setVisible(true);;
				Pergunta7.this.dispose();
			}
		});
		Resposta1.setIcon(new ImageIcon(Pergunta7.class.getResource("/imagens/p7r1.png")));
		...
		Resposta2.setIcon(new ImageIcon(Pergunta7.class.getResource("/imagens/p7r2.png")));
